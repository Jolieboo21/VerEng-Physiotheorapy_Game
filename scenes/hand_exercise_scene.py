...
class HandExerciseScene(Level1Scene):
    def __init__(self, screen, player_name, model, cap, videos, bg, plus_ten_image, congrat_image, score_sound, next_ex_sound):
        ...
        self.level = "Hand Exercise"  # Tên level cụ thể
        print(f"DEBUG: HandExerciseScene exercises: {self.exercises}, exercise_keys: {self.exercise_keys}, videos keys: {list(videos.keys())}")