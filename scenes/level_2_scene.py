...
class Level2Scene(Level1Scene):
    def __init__(self, screen, player_name, model, cap, videos, bg, plus_ten_image, congrat_image, score_sound, next_ex_sound):
        ...
        self.exercise_keys = list(videos.keys())[:5]  # Sử dụng 5 khóa tiếng Anh đầu tiên cho tìm video
        ...
        self.level = "Level 2"  # Tên level cụ thể
        print(f"DEBUG: Level2Scene exercises: {self.exercises}, exercise_keys: {self.exercise_keys}, videos keys: {list(videos.keys())}")